...
window.addEventListener('resize', function () {
  if (window.innerWidth > 640) menu.style.opacity = '1';else menu.style.opacity = '0';
  ...
  try {
    for (var _iterator3 = links[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      link.addEventListener('click', function () {
        ...
        try {
          for (var _iterator4 = burgerIcon.children[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
